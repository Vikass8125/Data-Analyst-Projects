-- Creating the pizzahut database
CREATE DATABASE if not exists pizzahut;

-- Using the pizzahut database
USE pizzahut;

-- Creating the orders table as the import data is huge
CREATE TABLE orders (
...
-- Creating the orders_details table as the import data is huge
...
select pizza_types.name, pizzas.pricedf_ordersdf_orders
...
group by orders.order_date) as order_qnty;
